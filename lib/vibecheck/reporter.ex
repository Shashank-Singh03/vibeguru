defmodule Vibecheck.Reporter do
  @moduledoc """
  ...
  `[Finding]`, many outputs:
    ...
    * `Vibecheck.Reporter.Json`     — `findings.json` for piping/programmatic use
    * `Vibecheck.Reporter.Markdown` — `report.md` + `CLAUDE.md` (agent-readable)
  ...
  """
  @callback render([Vibecheck.Finding.t()], map()) :: {:ok, term()} | {:error, term()}
end
